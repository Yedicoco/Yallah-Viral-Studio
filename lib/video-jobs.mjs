...
export function createVideoJob(project) {
...
async function runJob(job) {
  ...
  try {
    ...
    for (let frame = 0; frame < totalFrames; frame += 1) {
      ...
      drawStudioFrame(ctx, { project, timeline, elapsedSeconds: elapsed, width: WIDTH, height: HEIGHT });
    ...
    drawStudioFrame(ctx, { project, timeline, elapsedSeconds: 0.7, width: WIDTH, height: HEIGHT });
